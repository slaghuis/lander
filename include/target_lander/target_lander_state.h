...
namespace TargetLander {
  ...
  // Default camera yaw correction (Radianas anti-clockwise)
  static const float DEFAULT_CAMERA_YAW_CORRECTION = 0.0;
  
  // Field of view of the camera vertical (radians)
  static const float DEFAULT_CAMERA_VERTICAL_FOV = 0.851720675;  // Raspberry Pi 2.1
